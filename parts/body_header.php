		...
		<div class="head-main">
			...
			<nav>
				<ul>
					...
					<li><a class="nav-recruit" href="<?php echo site_url('/recruit'); ?>">採用情報</a></li>
				</ul>
			</nav>
		</div>
			...
			<div class="head-recruit">
				<nav>
					<ul>
						...
						<li<?php echo is_category('recruit-news') ? ' class="current_page_item"' : ''; ?>><a href="<?php echo get_category_link(get_category_by_slug('recruit-news')); ?>">インフォメーション</a></li><?php wp_list_pages(['title_li' => null, 'include' => get_page_by_path('recruit/entry')->ID]); ?>
					</ul>
				</nav>
			</div>
			<?php } ?>
